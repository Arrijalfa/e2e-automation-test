...
WebUI.setText(findTestObject('Object Repository/Register/input_email_email'), 'admin@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Register/input_password_password'), 'hUKwJTbofgPU9eVlw/CnDQ==')

WebUI.click(findTestObject('Object Repository/Register/svg_password_svg-inline--fa fa-eye-slash'))
